 ...
 * Esta clase guardará cantantes famosos
 ...
 * 
 * Luego, se debe mostrar los nombres de cada
 * cantante y su disco con más ventas por pantalla.
 * 
 * Una vez agregado los 5, en otro bucle, crear un menú que le de la opción al usuario de agregar un
 * cantante más, mostrar todos los cantantes, eliminar un cantante que el
 * usuario elija o de salir del programa.
 * 
 * Al final se deberá mostrar la lista
