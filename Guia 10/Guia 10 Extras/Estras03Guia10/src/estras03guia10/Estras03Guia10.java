 ...
 * ha podido realizar la operación y false en caso contrario. • Método toString
 * para mostrar los datos de los libros.
 *
 *
 * @author User
 */
public class Estras03Guia10 {

    /**
     * También se creará en el main un HashSet de tipo Libro que guardará todos
     * los libros creados.
     *
     * En el main tendremos un bucle que crea un objeto Libro pidiéndole al
     * usuario todos sus datos y los seteandolos en el Libro. Despues, ese Libro
     * se guarda en el conjunto y se le pregunta al usuario si quiere crear otro
     * Libro o no.
     *
    ...
    public static void main(String[] args) {
        ...
        libro.setTituloDeLibro(input.next());
        System.out.println("Ingrese el Autor");
        libro.setAutor(input.next());
        System.out.println("Ingrese el Numero de Ejemplares");
        libro.setNumeroDeEjemplares(input.nextInt());
        System.out.println("Ingrese el Numero de Ejemplares Prestados");
        libro.setNumerosdeEjemplaresPrestados(input.nextInt());
        L.add(libro);
        do {
            System.out.println("Desea Ingresar Otro libro? responda S/N");
            s = input.next();
        ...
        do{
       System.out.println("Desea Cargar Los Libros Prestados??  responder S/N");
       s=input.next(); 
        if (s.equalsIgnoreCase("s")) {
         System.out.println("Ingrese el Libro a Buscar");
         String titulo = input.next();
            for (Libro libro1 : L) {
                if (titulo.equalsIgnoreCase(libro1.getTituloDeLibro())) {
                    Prestamo();
                }
            }
        }else{
...
public void Prestamo(HashSet<Libro> libro){
        System.out.println("Ingrese el Numero de Ejemplares Prestados");
        libro.setNumerosdeEjemplaresPrestados(inpu.nextInt());
}
}
