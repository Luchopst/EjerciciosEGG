...
//      valor al atributo alumnos
    ...
    public Curso crearCurso() {
        ...
        System.out.println("Ingres el Turno");
...
//    que se repite el encuentro.
    ...
    public double calcularGananciaSemanal(Curso sem1){
        return sem1.getCantidadHorasPorDia()*sem1.getPrecioPorHora()*sem1.getAlumnos().length*sem1.getCantidadDiasPorSemana();
    }
